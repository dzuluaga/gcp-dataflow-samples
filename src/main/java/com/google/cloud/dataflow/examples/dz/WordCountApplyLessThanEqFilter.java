 ...
 *
 * <p>This class, {@link WordCountApplyLessThanEqFilter}, is the second in a series of four successively more detailed
 ...
 */
public class WordCountApplyLessThanEqFilter {
  ...
  public static class UseLessThanEqFilter extends PTransform<PCollection<WordCount>,
          PCollection<WordCount>> {
    @Override
    public PCollection<WordCount> apply(PCollection<WordCount> words) {

      PCollection<WordCount> longWords =
              words.apply(Filter.<WordCount>lessThanEq(new WordCount("",5L)));
  ...
  /**
   * Options supported by {@link WordCountApplyLessThanEqFilter}.
   *
